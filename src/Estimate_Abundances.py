...
parser.add_argument("-w","--window_size", default="1500",help="Size of the sliding to test statistics to identify changepoints in coverages (Default=1500)", required = False)
