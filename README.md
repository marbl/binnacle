...
usage: Calculate_Coverages.py [-h] -g ASSEMBLY -a COVERAGE -c CONTIGS -d DIR
                              [-b BINNING] [-A ALL_VS_ALL_ALIGNMENTS_FLAG]
                              [-M ALIGNMENTS]

binnacle: A tool for binning metagenomic datasets using assembly graphs and
scaffolds generated by metacarvel.Calculate_Coverages.py estimates abundance
for scaffolds generated by MetaCarvel.
...
optional arguments:
  ...
  -b BINNING, --binning BINNING
                        ...
                        outputs 1. Metabat 2. Maxbin2 3. Concoct 4. Binnacle's
                        binning algorithm (default)
  -A ALL_VS_ALL_ALIGNMENTS_FLAG, --all_vs_all_alignments_Flag ALL_VS_ALL_ALIGNMENTS_FLAG
                        Perform All vs All Alignments
  -M ALIGNMENTS, --alignments ALIGNMENTS
                        Output generated by running genomecov -d on the bed
                        files gnerated by mapping all reads to all assemblies
```
